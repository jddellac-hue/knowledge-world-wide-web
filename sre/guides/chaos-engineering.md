...
Le chaos engineering tel que décrit par le *Principles of Chaos* de Netflix [📖¹](https://principlesofchaos.org/ "Principles of Chaos Engineering (Netflix / ChaosConf)") est défini sur un service. À l'échelle d'une grande organisation tech, **trois ajustements** s'imposent :
...
2. [Microsoft Azure WAF — Testing strategy](https://learn.microsoft.com/en-us/azure/well-architected/reliability/testing-strategy "Microsoft Azure WAF — Reliability, Testing strategy") — error budget as investment

Ressources complémentaires :
- [Netflix Tech Blog — The Netflix Simian Army](https://netflixtechblog.com/the-netflix-simian-army-16e57fbab116 "Netflix Tech Blog — The Netflix Simian Army (2011)") — origine historique 2011
